...
| :-: | :--------------------: | :--------: | :----------------------------: | :----------------: | :-----------------------------------------------------------------------------------------------------------------: |
|  1  |        position        |    true    |            ILatLng             |                    |                                                   Vị trí trên map                                                   |
|  2  |        visible         |   false    |            boolean             |        true        |                                                  Cho phép hiển thị                                                  |
|  3  |         anchor         |   false    |             IPoint             | \{x: 0.5, y: 1.0\} |                                            vị trí điểm neo so với marker                                            |
|  4  |      labelAnchor       |   fasle    |             IPoint             | \{x: 0.5, y: 0.5\} |                                            Vị trí điểm neo so với label                                             |
...
| 10  |      windowAnchor      |   false    |             IPoint             | \{x: 0.5, y: 0.0\} |       Xác định điểm neo so với bảng thông tin của Marker. Bảng thông tin này sẽ hiện lên khi click vào Marker       |
