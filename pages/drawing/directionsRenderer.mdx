...
| :-: | :----------------------: | :--------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-----------: | :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|  1  |          routes          |   false    | string \| [RouteOptions](https://docs.map4d.vn/map4d-map/web/v2.4/#/reference/directions-renderer?id=routeoptions)\| [ILatLng](https://docs.map4d.vn/map4d-map/web/v2.4/#/reference/coordinates?id=ilatlng)[][] |               | Truyền vào một mảng 2 chiều các tọa độ [ILatLng](https://docs.map4d.vn/map4d-map/web/v2.4/#/reference/coordinates?id=ilatlng) hoặc dữ liệu Route bằng JSON string trả về từ Map4D SDK API Route hoặc một đối tượng [RouteOptions](https://docs.map4d.vn/map4d-map/web/v2.4/#/reference/directions-renderer?id=routeoptions) để tạo Directions Renderer. |
...
|  7  |   activeStrokePattern    |   fasle    |                                                             [PatternItem](https://docs.map4d.vn/map4d-map/web/v2.4/#/reference/map?id=patternitem)                                                              |               |                                                                                                                                           Chỉ định pattern của active line. Tương tự như pattern của Polyline                                                                                                                                           |
...
| 12  |  inactiveStrokePattern   |   fasle    |                                                             [PatternItem](https://docs.map4d.vn/map4d-map/web/v2.4/#/reference/map?id=patternitem)                                                              |               |                                                                                                                                        Chỉ định pattern của inactive outline. Tương tự như pattern của Polyline                                                                                                                                         |
| 13  |   originMarkerOptions    |   fasle    |                                                         [MarkerOptions](https://docs.map4d.vn/map4d-map/web/v2.4/#/reference/marker?id=marker-options)                                                          |               |                                                                                                                                                        Chỉ định các options cho marker bắt đầu.                                                                                                                                                         |
| 14  | destinationMarkerOptions |   fasle    |                                                         [MarkerOptions](https://docs.map4d.vn/map4d-map/web/v2.4/#/reference/marker?id=marker-options)                                                          |               |                                                                                                                                                        Chỉ định các options cho marker kết thúc.                                                                                                                                                        |
| 15  |  waypointMarkerOptions   |   fasle    |                                                        [MarkerOptions](https://docs.map4d.vn/map4d-map/web/v2.4/#/reference/marker?id=marker-options)[]                                                         |               |                                                                                                                          Là mảng marker option chỉ định các marker waypoint. Các marker waypoint này có vị trí nằm ngoài route                                                                                                                          |
