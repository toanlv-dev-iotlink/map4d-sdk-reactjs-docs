...
| :-: | :--------------------: | :--------: | :-----: | :-----------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|  1  |        position        |    true    | [ILatLng](https://docs.map4d.vn/map4d-map/web/v2.4/#/reference/coordinates?id=ilatlng) |               |                                                                    Chỉ định một [ILatLng](https://docs.map4d.vn/map4d-map/web/v2.4/#/reference/coordinates?id=ilatlng) để xác định vị trí ban đầu của POI.                                                                    |
