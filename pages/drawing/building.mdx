...
| :-: | :--------------------: | :--------: | :-------: | :-----------: | :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|  1  |        position        |    true    |  ILatLng  |               |                                                                                                                                                                             Chỉ định một ILatLng để xác định vị trí của Building.                                                                                                                                                                             |
...
|  6  |         height         |   fasle    |  number   |       1       |                                                                   Chỉ định chiều cao của Building theo đơn vị là mét. Thuộc tính này chỉ có tác dụng khi Building của bạn được tạo từ một mảng ILatLng thông qua thuộc tính coordinates (hay còn gọi là Extrude Building). Nó không có tác dụng với Building được vẽ bằng Model và Texture.                                                                   |
...
|  9  |      coordinates       |   fasle    | ILatLng[] |               | Chỉ định một mảng vị trí ILatLng để tạo một Building hình khối với mặt đáy của hình khối là mảng vị trí này. Nó kết hợp với thuộc tính height để tạo chiều cao cho hình khối đó (building này được gọi là Extrude Building). Trường hợp dùng coordinates thì sẽ không dùng đến thuộc tính texture. Nếu set giá trị cho coordinates và cả model đồng thời thì sẽ ưu tiên lấy giá trị của modelđể tạo Building. |
