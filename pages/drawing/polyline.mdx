...
| :-: | :--------------------: | :--------: | :--------------------------------: | :-----------: | :----------------------------------------------------------------------------------------------------------------------------------------------------: |
|  1  |          path          |    true    |             [ILatLng](https://docs.map4d.vn/map4d-map/web/v2.4/#/reference/coordinates?id=ilatlng)[]              |               |                                                 Truyền vào một mảng các tọa độ [ILatLng](https://docs.map4d.vn/map4d-map/web/v2.4/#/reference/coordinates?id=ilatlng) để tạo Polyline                                                 |
...
| 10  |     strokePattern      |   false    |            [PatternItem](https://docs.map4d.vn/map4d-map/web/v2.4/#/reference/map?id=patternitem)             | SolidPattern  | Chỉ định kiểu vẽ của Polyline (SolidPattern, DashPattern, DotPattern hay IconPattern) Chỉ định độ cao của Polyline so với mực nước biển, đơn vị là mét |
